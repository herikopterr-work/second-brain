...
-- Policy Single-User: Mengizinkan akses penuh
DO $$ 
DECLARE
    tbl text;
...
BEGIN
    FOREACH tbl IN ARRAY tables LOOP
        ...
        EXECUTE format('CREATE POLICY "Owner full access policy" ON %I FOR ALL USING (true) WITH CHECK (true);', tbl);
    END LOOP;
END $$;
